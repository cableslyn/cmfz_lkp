...
public class AdminController {
    ...
    @ResponseBody
    public Map<String,Object> regist(Admin admin,String sms,HttpServletRequest request){
        HashMap<String, Object> map = new HashMap<>();
        try {
            adminService.regist(admin,sms,request);
            map.put("status",true);
        } catch (Exception e) {
            e.printStackTrace();
            map.put("status",false);
    ...
    @ResponseBody
    public void sendMessage(String phone,HttpServletRequest req) throws Exception {
        //设置超时时间-可自行调整
